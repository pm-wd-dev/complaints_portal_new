...
<body>
    <div class="email-container">
        ...
        <div class="assignment-alert">
            <h2 style="margin: 0; color: #1976d2;">📋 New Complaint Assignment</h2>
        </div>

        <p>Dear {{ $respondent->name }},</p>

        <p>You have been assigned to respond to a new complaint. Please review the details below and take appropriate action within the required timeframe.</p>
        ...
        <div class="urgency">
            ⚠️ RESPONSE REQUIRED WITHIN 48 HOURS ⚠️
        </div>
        ...
        <div class="complainant-info">
            ...
            @endif
            <p><strong>Submission Date:</strong> {{ $complaint->created_at->format('F j, Y \a\t g:i A') }}</p>
        </div>
        ...
        <div style="text-align: center;">
            <h3><a href="{{ route('respondent.login') }}" class="button">🔍 For Access Respondent Portal click Here</a></h3>
            <br>
        ...
        <div class="details">
            ...
            <ol>
                ...
                <li>Gather any additional information needed</li>
                <li>Prepare your response addressing all concerns</li>
                <li>Submit your response through the system within 48 hours</li>
                <li>Follow up as necessary until resolution</li>
            </ol>
        </div>

        <div class="urgency">
            <p style="margin: 0;"><strong>⏰ Important:</strong> This complaint requires your immediate attention. Please log in and respond as soon as possible to maintain our service standards.</p>
        </div>

        <div class="footer">
            <p><strong>GoBEST™ Cast Member Notification System</strong></p>
            <p>Case ID: {{ $complaint->case_number }} | Assigned: {{ now()->format('M j, Y g:i A') }}</p>
            <p>This is an automated notification. Please log into the cast member portal to take action.</p>
        </div>
    </div>
</body>
</html>